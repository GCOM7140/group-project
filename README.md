...
The goal of this group project is to give you an opportunity to apply the skills
...
Laundry][tjl] (TJL), a local Charlottesville business that's partnering with us
...
you'll be at [generating, disseminating, and responding][Jaworski and Kohli
...
### Tasks
Your tasks are to identify an area of the business that's worth looking into;
make a data-informed and principled decision on what direction TJL should go in;
and develop a convincing action plan that logically flows from what you learn.
...
* __Casts a wide net__
   ...
   multitude of outcome variables, boundary conditions, and explanations.
...
divergent in your thinking ([Peng 2018][]). Conduct extensive research on
Elevate, Euromonitor, Factiva, Google Trends, Instagram, Yelp, etc. This
research, which can also occur in TJL's and its competitors' storefronts, will
uncover challenges that TJL is facing (e.g., some consumers perceive that TJL
offers low [value][Zeithaml 1988]) and a number of promising alternatives that
TJL could consider implementing to address these challenges (e.g., launching an
Instagram campaign focused on educating their followers about the true cost of
food).

   __Pro tip__: Be radically open minded&mdash;and [productively
   stupid][Schwartz 2008]&mdash;during this step and strive not to let
   ...
   will add rigor to your analysis/insights.
...
(2011)][Colquitt and George 2011] offer to select three challenges (i.e.,
"topics") that you believe are most worth looking into and highlight these in
Table 1. From here, you will arrive at the topic that you will do further
research and reporting on for your group project report and presentation.

   __Pro tip__: Explain your topics clearly in Table 1, so that Mike and Sarah
   will be able to grasp: (a) the challenges your topics are focused on
